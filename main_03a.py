...
MODEL_PRICES = {
    "input": {
        "gpt-4o-mini": 0.5 / 1_000_000,
        "gpt-4o": 5 / 1_000_000,
        "claude-3-5-sonnet-20240620": 3 / 1_000_000,
        "gemini-1.5-pro-latest": 3.5 / 1_000_000
    },
    "output": {
        "gpt-4o-mini": 1.5 / 1_000_000,
        "gpt-4o": 15 / 1_000_000,
...
def select_model():
    ...
    models = ("GPT-4o-mini", "GPT-4", "Claude 3.5 Sonnet", "Gemini 1.5 Pro")
...
def get_message_counts(text):
    if "gemini" in st.session_state.model_name:
        ...
        if "gpt" in st.session_state.model_name:
            ...
            encoding = tiktoken.encoding_for_model("gpt-4o-mini")  # 仮のものを利用
